...
-- *
-- * Demonstrates use of precedence and associativity
-- * declarations
-- *
...
-- Precedence specification to resolve ambiguities.
-- The relative precedence is implicit in the ordering:
-- lower precedences precede higher precedences.
